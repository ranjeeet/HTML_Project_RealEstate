...
<head>
    ...
    -->
    <meta charset="utf-8">
    <title>Add New Honourable Client</title>
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-plus"></i> Add New Team Mamber Details:</h2>
   ...
   <div style="padding:25px">
                <div class="control-group">
				 ...
				 <div class="control-group">
                  ...
                  <div class="input-group col-md-4">
                    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                    <input type="text" class="form-control" placeholder="Enter URL" name="Dname">
                </div>
...
<div class="row">
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-plus"></i> Upload logo</h2>
            ...
            if(isset($_POST["save"]))
            {
                ...
                $query="insert into honourable_client set name='$name',url='$Designation',logo='$file'";
                $data=mysql_query($query);//execute your query or f5
                        if($data>0)
                        {
                            echo "<script>alert('Submit successful')</script>";
							echo "<script>window.location.href='ManageHonourableClient.php'</script>";
                        }
 else {

    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-plus"></i> Add New Slide:</h2>
   ...
   <div style="padding:25px">
                <div class="control-group">
                  ...
                  <div class="input-group col-md-4">
                    ...
                    <input type="text" class="form-control" placeholder="Enter Heading" name="Tname">
                </div>
				 ...
				 <div class="control-group">
                  ...
                  <div class="input-group col-md-4">
                    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                    <input type="text" class="form-control" placeholder="Type Your Paragraph" name="Dname">
                </div>
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            ...
            if(isset($_POST["save"]))
            {
               ...
               $query="insert into slider set heading='$name',para='$Designation',image='$file'";

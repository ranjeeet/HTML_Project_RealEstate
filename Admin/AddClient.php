...
<div class="row">
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-plus"></i> Add New Client Form:</h2>
   ...
   <div style="padding:25px">
                <div class="control-group">
				 ...
				 <div class="control-group">
                    <label class="control-label" for="selectError1">Comment</label>
...
<div class="row">
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-plus"></i> Client Images</h2>
            ...
            <div class="box-content">
					...
					Client Picture Preview<br>
					
					<img src="../images/author.png" height="100" width="100"><br>
                     <a class="btn btn-danger" href="ManageClient.php"><i class="glyphicon glyphicon-arrow-left"></i>&nbsp;&nbsp;Back</a>
            ...
            if(isset($_POST["save"]))
            {
               ...
               $query="insert into manage_client set name='$name',comment='$Designation',image='$file'";
                $data=mysql_query($query);//execute your query or f5
                        if($data>0)
                        {
                            echo "<script>alert('Your Client Detail Submit successful')</script>";
							header('location:ManageClient.php');
                        }
 else {
     echo "<script>alert('Your Client Detail Not Submit successful')</script>";
 }

...
<?php
$query="select * from manage_client where id='$var'";
   ...
   <div style="padding:25px">
                <div class="control-group">
				 ...
				 <div class="control-group">
                    ...
                    <textarea name="Dname" id="comment"><?php echo $data['comment'];?></textarea>
                </div>
...
<div class="row">
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-edit"></i> Edit Client Images</h2>
			...
			if($file=="")
                ...
                $query="update manage_client set name='$name',comment='$Designation',image='$imgs' where id='$var'";

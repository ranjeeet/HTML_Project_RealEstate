...
<?php
$query="select * from manage_team where id='$var'";
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-plus"></i> Edit Team Mamber Form:</h2>
...
<div class="row">
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-edit"></i> Edit Team Mamber Images</h2>
			...
			Preview Image:<br>
					...
					<img src="AdminProfilePic/<?php echo $data['image'];?>" height="100" width="100"><br>
                     <br/>
			...
			if($file=="")
                ...
                $query="update manage_team set name='$name',designation='$Designation',image='$imgs' where id='$var'";
                $data=mysql_query($query);//execute your query or f5
                        if($data>0)
                        {
                            echo "<script>alert('Your Team Member Edit Submit successful')</script>";
							header('location:ManageTeam.php');                        }
 else {
     echo "<script>alert('Your Team Member Not Edit Submit successful')</script>";
 }

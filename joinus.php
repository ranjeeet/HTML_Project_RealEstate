...
<head>
    ...
    <!-- Basic -->
    <title>Realestate | Join Us</title>
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="contact-section">
                ...
                move_uploaded_file($file_loc, "img/JoinUsFiles/".$file);
						
				
					$query_us="insert into managejoinus set Name='$name',Contact='$contact',Email='$email',Download='$file'";
